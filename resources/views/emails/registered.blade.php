        ...
        <tbody>
            <tr style="vertical-align: top;" valign="top">
                <td style="word-break: break-word; vertical-align: top;" valign="top">
                                                    ...
                                                    <tr style="vertical-align: top;" valign="top">
                                                        <td class="divider_inner"
                                                            ...
                                                            <table class="divider_content" border="0" cellpadding="0"
                                                                ...
                                                                align="center" role="presentation" height="10"
                                                                valign="top">
                                                                <tbody>
                                                                    <tr style="vertical-align: top;" valign="top">
                                ...
                                <div class="col num6"
                                    ...
                                    <div class="col_cont" style="width:100% !important;">
                                        ...
                                        <div
                                            ...
                                            <!--<![endif]-->
                                            <div class="img-container left fixedwidth" align="left"
                                                ...
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="left"><![endif]--><img
                                                    class="left fixedwidth" border="0"
                                                    src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/326/Logo.png"
                                                    alt="Image" title="Image"
                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 195px; display: block;"
                                                    width="195">
                    ...
                    <div style="background-color:transparent;">
                        <div class="block-grid "
                            style="min-width: 320px; max-width: 650px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: #D6E7F0;">
                                    ...
                                    <div class="col_cont" style="width:100% !important;">
                                        ...
                                        <div
                                            ...
                                            <div class="img-container center fixedwidth" align="center"
                                                ...
                                                <div style="font-size:1px;line-height:45px">&nbsp;</div><img
                                            ...
                                            <div class="button-container" align="center"
                                                ...
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 20px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $data['url'] }}" style="height:39pt;width:210pt;v-text-anchor:middle;" arcsize="29%" stroke="false" fillcolor="#fc7318"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Tahoma, Verdana, sans-serif; font-size:16px"><![endif]-->
                                                Please confirm that {{ $data['email'] }} is your email address, by
                                                clicking on the button below
                                                or
                                                open this link<a href="{{ $data['url'] }}" target="_blank"
